        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressInfoId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurposeDivisions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurposeDivisionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Categories_PurposeDivisions_PurposeDivisionId",
                        column: x => x.PurposeDivisionId,
                        principalTable: "PurposeDivisions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProductImages", x => x.id);
                    table.ForeignKey(
                        name: "FK_UserProductImages_UserProducts_UserProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProductReviews_UserProducts_UserProductId",
                        column: x => x.UserProductId,
                        principalTable: "UserProducts",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_PurposeDivisionId",
                table: "Categories",
                column: "PurposeDivisionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProductImages_UserProductId",
                table: "UserProductImages",
                column: "UserProductId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProductReviews_UserProductId",
