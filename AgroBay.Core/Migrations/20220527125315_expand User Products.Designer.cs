...
{
    [DbContext(typeof(AgroBayDbContext))]
    [Migration("20220527125315_expand User Products")]
    partial class expandUserProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroBay.Core.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PurposeDivisionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AgroBay.Core.Model.Category", b =>
                {
                    b.HasOne("AgroBay.Core.Model.PurposeDivision", "PurposeDivision")
                        .WithMany()
                        .HasForeignKey("PurposeDivisionId")
            ...
            modelBuilder.Entity("AgroBay.Core.Model.SubCategory", b =>
                {
                    b.HasOne("AgroBay.Core.Model.Category", "Categories")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AgroBay.Core.Model.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
