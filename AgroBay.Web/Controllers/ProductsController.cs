...
namespace AgroBay.Web.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(AgroBayDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,MainImage,Description,ShortDescription,SubCategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,MainImage,Description,ShortDescription,SubCategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
