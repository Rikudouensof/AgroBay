...
namespace AgroBay.DBTes.Controllers
{
    public class UserProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,ProductId,UserId,AvailableQuantity,ImageUrl,isSold,Price")] UserProduct userProduct)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,ProductId,UserId,AvailableQuantity,ImageUrl,isSold,Price")] UserProduct userProduct)
        {
